...
public class BuildWordCloudTask extends AsyncTask<Integer, Void, List<Word>> {
    ...
    protected List<Word> doInBackground(Integer... values) {
        ...
        List<Word> wordList = wordCloudService.buildWordCloud(textAnalyzerService.getWordCountMap(WordCloudServiceImpl.NUMBER_OF_WORDS), textAnalyzerService.getHighestWordCount());
