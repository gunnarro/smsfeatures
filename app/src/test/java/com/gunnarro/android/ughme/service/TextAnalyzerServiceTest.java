...
public class TextAnalyzerServiceTest {
    ...
    public void analyzeText() {
        ...
        AnalyzeReport report = service.analyzeText("Dette, dette, dette er kun en enhets test, og dette er ingen ting å tule med, spør du meg. antall enhets tester er kun 1", Sms.INBOX,null, 3);
    ...
    public void analyzeTextEmptyText() {
        TextAnalyzerServiceImpl service = new TextAnalyzerServiceImpl();
        AnalyzeReport report = service.analyzeText("", Sms.INBOX, TextAnalyzerServiceImpl.DEFAULT_WORD_REGEXP, 10);
    ...
    public void analyzeTextShortText() {
        TextAnalyzerServiceImpl service = new TextAnalyzerServiceImpl();
        AnalyzeReport report = service.analyzeText("Android is always a sweet treat!", Sms.INBOX,TextAnalyzerServiceImpl.DEFAULT_WORD_REGEXP,10);
