...
public class TextAnalyzerServiceLoadTest {
    ...
    public void analyzeText() {
        ...
        AnalyzeReport report = service.analyzeText(TestData.createAllSmsAsText(), "\\b\\w{3,}", 10);
        ...
        Assert.assertEquals("{jeg=3779, det=3527, ikke=2735, til=1740, deg=1722, har=1704, med=1509, meg=1204, for=1160, kan=1111}", report.getWordMap());
    }
}
